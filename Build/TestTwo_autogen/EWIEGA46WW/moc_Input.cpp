...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Input_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Input_t qt_meta_stringdata_Input = {
    {
QT_MOC_LITERAL(0, 5) // "Input"
...
const QMetaObject Input::staticMetaObject = { {
    ...
    qt_meta_stringdata_Input.offsetsAndSize,
    qt_meta_data_Input,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Input_t
