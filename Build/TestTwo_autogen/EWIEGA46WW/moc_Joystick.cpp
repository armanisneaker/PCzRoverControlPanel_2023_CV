...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Joystick_t, stringdata0) + ofs), len 
...
const QMetaObject Joystick::staticMetaObject = { {
    ...
    qt_meta_stringdata_Joystick.offsetsAndSize,
    qt_meta_data_Joystick,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Joystick_t
